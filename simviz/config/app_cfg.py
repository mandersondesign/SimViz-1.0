# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in simviz.
...
from simviz.lib import app_globals, helpers 

base_config = AppConfig()
base_config.renderers = []
base_config.prefer_toscawidgets2 = True

base_config.package = simviz
...
base_config.model = simviz.model
base_config.DBSession = simviz.model.DBSession
